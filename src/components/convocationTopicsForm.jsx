...
class ConvocationTopicsForm extends Component {
  ...
  async handleSubmit () {
    ...
    const result = await this.fetchAPI('convocations', 'topics', this.state.convocation._id, null, options)
              ...
              <section>
                <label htmlFor='availableTopics'>
                  ...
                  >
                    ...
                    {this.state.selectableTopics
                      ? this.state.selectableTopics.map((topic) => {
                        return (
