...
class QuestionForm extends Component {
  ...
  // FIXME: error after create new question
          ...
          <article>
            ...
            <div className='grid'>
              <form>
                ...
                <label>
                  Tema
                  <select
                    name='topic' type='text' required
                    placeholder='Tema al que Corresponde la Pregunta'
                    aria-invalid={(this.state.topic === null) ? null : !this.state.topic}
                    onChange={this.handleInputChange}
                    value={
                                            this.state.question && this.state.question.topic
                                              ? this.state.question.topic._id
            ...
            <footer>
              ...
              <a
                ...
                disabled={!(this.state.question && this.state.editing)}
